      ...
      <article className="xp-article">
        ...
        <div className="xp-blocks">
          ...
          <Block heading="How we use your information">
            ...
            <p>
              <strong>Marketing email.</strong> If you are a client of TeddyBed OS, or you gave us your
          ...
          <Block heading="How we share your information">
            <p>
              We share information with service providers who help us run TeddyBed OS, under
          ...
          <Block heading="Your rights and choices">
            <p>
              ...
              emailing{' '}
              <a href="mailto:hello@teddybed.com.au">hello@teddybed.com.au</a>. Depending on where you live, you
            ...
            <p>
              ...
              <a href="mailto:hello@teddybed.com.au">hello@teddybed.com.au</a>. Unsubscribing from marketing does
          ...
          <Block heading="International data transfers">
            <p>
              TeddyBed OS operates across the United States and Vietnam. By using our services, you
